...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/07 16:59:13 by sjhony-x          #+#    #+#             */
/*   Updated: 2023/03/07 16:59:14 by sjhony-x         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	check_word(t_parser *parser, t_token *current_token)
{
	while (parser->current_token->type == TK_WORD)
	{
		...
		ft_add_back(&parser->commands, ft_new_env(
				parser->index, current_token->value));
